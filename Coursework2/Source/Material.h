...
public:
	...
	XMCOLOR getEmissive(){ return colour.emissive; };
	XMCOLOR  getAmbient(){ return colour.ambient; };
	XMCOLOR  getDiffuse(){ return colour.diffuse; };
	XMCOLOR  getSpecular(){ return  colour.specular; };
